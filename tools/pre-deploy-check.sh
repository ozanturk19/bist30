...
# 2. Python compile
echo ""
echo "2/25 Python compile (app.py)..."
...
# tutulmalı.
echo ""
echo "3/25 KALICI_KURALLAR audit..."
...
# 4. format-lint
echo ""
echo "4/25 format-lint (CPO-1180 K6)..."
...
echo ""
echo "5/25 CSS token guard (CPO-1349)..."
...
echo "6/25 style-guard (T1.7: sablon ici var()/ham hex/yerel :root/bos catch ratchet)..."
...
echo ""
echo "7/25 lint_scope ratchet (T9.4: sablon sayisi daralma dedektoru)..."
...
echo ""
echo "8/25 node-syntax-check (DEV2-T-MOBOVF-1: sablon-ici JS sozdizimi)..."
...
echo ""
echo "9/25 state-order-check (K-G: durum kurali varyantin ALTINDA olmali)..."
...
echo ""
echo "10/25 contrast-check (K-I: ayni kuralda bg+fg WCAG kontrasti)..."
...
echo ""
echo "11/25 cachebust-check (K-J: ?v= referansi diskteki hash ile ayni mi)..."
...
echo ""
echo "12/25 legal-text-sync-check (K-H: hukuki metin <-> 'Son guncelleme' senkronu)..."
...
echo ""
echo "13/25 da-override-check (K-K: .da-* bildirimini kisayolla silme)..."
...
echo ""
echo "14/25 canon-conflict-check (K-AP: kanonik kaynak <-> sayfa-yerel kopya)..."
...
echo ""
echo "15/25 glyph-canon-check (K-AQ: rozet glifi <-> kanonik anlam)..."
...
echo ""
echo "16/25 threshold-sync-check (K-AR: bant esigi kopyalari <-> business_rules)..."
...
echo ""
echo "17/25 nav-label-canon-check (K-AS: gezinme etiketi kanonu)..."
...
echo ""
echo "18/25 tooltip-canon-check (K-AT: ipucu mekanizmasi kanonu)..."
...
echo ""
echo "19/25 sort-canon-check (K-AV: siralama kontrolu durum kanonu)..."
...
echo ""
echo "20/25 newtab-canon-check (K-AW: yeni sekme uyarisi kanonu)..."
...
echo ""
echo "21/25 autorefresh-canon-check (K-AX: periyodik yenileme odak kanonu)..."
...
echo "22/25 sticky-anchor-check (K-AY: yapiskan capa kanonu)..."
...
echo "23/25 safearea-layer-check (K-AZ: guvenli alan kapsam kanonu)..."
...
echo "24/25 tr-decimal-input-check (K-BA: TR ondalik girdi kanonu)..."
...
echo "25/25 tr-calendar-day-check (K-BD: TR takvim gunu kanonu)..."
