...
# 2. Python compile
echo ""
echo "2/7 Python compile (app.py)..."
...
echo ""
echo "3/7 KALICI_KURALLAR audit..."
...
# 4. format-lint
echo ""
echo "4/7 format-lint (CPO-1180 K6)..."
...
echo ""
echo "5/7 CSS token guard (CPO-1349)..."
...
echo "6/7 style-guard (T1.7: sablon ici var()/ham hex/yerel :root/bos catch ratchet)..."
...
echo ""
echo "7/7 lint_scope ratchet (T9.4: sablon sayisi daralma dedektoru)..."
