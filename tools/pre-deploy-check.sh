...
# 2. Python compile
echo ""
echo "2/26 Python compile (app.py)..."
...
# tutulmalı.
echo ""
echo "3/26 KALICI_KURALLAR audit..."
...
# 4. format-lint
echo ""
echo "4/26 format-lint (CPO-1180 K6)..."
...
echo ""
echo "5/26 CSS token guard (CPO-1349)..."
...
echo "6/26 style-guard (T1.7: sablon ici var()/ham hex/yerel :root/bos catch ratchet)..."
...
echo ""
echo "7/26 lint_scope ratchet (T9.4: sablon sayisi daralma dedektoru)..."
...
echo ""
echo "8/26 node-syntax-check (DEV2-T-MOBOVF-1: sablon-ici JS sozdizimi)..."
...
echo ""
echo "9/26 state-order-check (K-G: durum kurali varyantin ALTINDA olmali)..."
...
echo ""
echo "10/26 contrast-check (K-I: ayni kuralda bg+fg WCAG kontrasti)..."
...
echo ""
echo "11/26 cachebust-check (K-J: ?v= referansi diskteki hash ile ayni mi)..."
...
echo ""
echo "12/26 legal-text-sync-check (K-H: hukuki metin <-> 'Son guncelleme' senkronu)..."
...
echo ""
echo "13/26 da-override-check (K-K: .da-* bildirimini kisayolla silme)..."
...
echo ""
echo "14/26 canon-conflict-check (K-AP: kanonik kaynak <-> sayfa-yerel kopya)..."
...
echo ""
echo "15/26 glyph-canon-check (K-AQ: rozet glifi <-> kanonik anlam)..."
...
echo ""
echo "16/26 threshold-sync-check (K-AR: bant esigi kopyalari <-> business_rules)..."
...
echo ""
echo "17/26 nav-label-canon-check (K-AS: gezinme etiketi kanonu)..."
...
echo ""
echo "18/26 tooltip-canon-check (K-AT: ipucu mekanizmasi kanonu)..."
...
echo ""
echo "19/26 sort-canon-check (K-AV: siralama kontrolu durum kanonu)..."
...
echo ""
echo "20/26 newtab-canon-check (K-AW: yeni sekme uyarisi kanonu)..."
...
echo ""
echo "21/26 autorefresh-canon-check (K-AX: periyodik yenileme odak kanonu)..."
...
echo "22/26 sticky-anchor-check (K-AY: yapiskan capa kanonu)..."
...
echo "23/26 safearea-layer-check (K-AZ: guvenli alan kapsam kanonu)..."
...
echo "24/26 tr-decimal-input-check (K-BA: TR ondalik girdi kanonu)..."
...
echo "25/26 tr-calendar-day-check (K-BD: TR takvim gunu kanonu)..."
...
echo "26/26 global-collision-check (K-BE: kuresel ad cakismasi)..."
