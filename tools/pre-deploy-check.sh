...
# 2. Python compile
echo ""
echo "2/23 Python compile (app.py)..."
...
# tutulmalı.
echo ""
echo "3/23 KALICI_KURALLAR audit..."
...
# 4. format-lint
echo ""
echo "4/23 format-lint (CPO-1180 K6)..."
...
echo ""
echo "5/23 CSS token guard (CPO-1349)..."
...
echo "6/23 style-guard (T1.7: sablon ici var()/ham hex/yerel :root/bos catch ratchet)..."
...
echo ""
echo "7/23 lint_scope ratchet (T9.4: sablon sayisi daralma dedektoru)..."
...
echo ""
echo "8/23 node-syntax-check (DEV2-T-MOBOVF-1: sablon-ici JS sozdizimi)..."
...
echo ""
echo "9/23 state-order-check (K-G: durum kurali varyantin ALTINDA olmali)..."
...
echo ""
echo "10/23 contrast-check (K-I: ayni kuralda bg+fg WCAG kontrasti)..."
...
echo ""
echo "11/23 cachebust-check (K-J: ?v= referansi diskteki hash ile ayni mi)..."
...
echo ""
echo "12/23 legal-text-sync-check (K-H: hukuki metin <-> 'Son guncelleme' senkronu)..."
...
echo ""
echo "13/23 da-override-check (K-K: .da-* bildirimini kisayolla silme)..."
...
echo ""
echo "14/23 canon-conflict-check (K-AP: kanonik kaynak <-> sayfa-yerel kopya)..."
...
echo ""
echo "15/23 glyph-canon-check (K-AQ: rozet glifi <-> kanonik anlam)..."
...
echo ""
echo "16/23 threshold-sync-check (K-AR: bant esigi kopyalari <-> business_rules)..."
...
echo ""
echo "17/23 nav-label-canon-check (K-AS: gezinme etiketi kanonu)..."
...
echo ""
echo "18/23 tooltip-canon-check (K-AT: ipucu mekanizmasi kanonu)..."
...
echo ""
echo "19/23 sort-canon-check (K-AV: siralama kontrolu durum kanonu)..."
...
echo ""
echo "20/23 newtab-canon-check (K-AW: yeni sekme uyarisi kanonu)..."
...
echo ""
echo "21/23 autorefresh-canon-check (K-AX: periyodik yenileme odak kanonu)..."
...
echo "22/23 sticky-anchor-check (K-AY: yapiskan capa kanonu)..."
...
echo "23/23 safearea-layer-check (K-AZ: guvenli alan kapsam kanonu)..."
